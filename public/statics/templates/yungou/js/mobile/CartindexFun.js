    ...
    var b = function () {
        ...
        var m = function () {
            ...
            if (r > 0) {
                ...
                g.children("p").html('' +
                    '总共购买<span class="orange arial z-user">' + r + '</span>个奖品' +
                    '  合计金额：<span id="total" class="orange arial">' + q + ".00</span> 元")
            } else {
                g.remove()
            }
        };
            ...
            var s = function (w) {
                if (w.code == 1) {
                    ...
                    if (w.code == 0) {
                        ...
                        // console.log(ids);
                        q.parent().prev().html('总共参与：<em class="arial proce" id="arial' + ids + '" ids="' + ids + '">' + r + '</em>人次/' +
                            '<em class="orange arial" id="orange' + ids + '" ids="' + ids + '">￥' + r * yjg + "</em>")
                    }
                }
            };
