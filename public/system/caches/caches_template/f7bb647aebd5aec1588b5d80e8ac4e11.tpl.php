...
<!-- 栏目导航 -->
    ...
    <p  style="width:200px; margin:0 auto; height:80px; line-height:40px; font-weight:700;text-align: center;padding-top: 90px;">
        邀请好友得佣金哦！<br>
        我的专属二维码：
    </p>
    <div style="width:200px; margin:0 auto;"><img src="http://qr.topscan.com/api.php?bg=ffffff&fg=000000&el=l&w=200&m=10&text=<?php echo WEB_PATH; ?>/mobile/user/register/<?php echo $uid; ?>/"/></div>
</div>
