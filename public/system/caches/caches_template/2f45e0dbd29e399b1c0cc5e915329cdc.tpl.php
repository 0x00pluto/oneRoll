...
<div class="R-content">
	...
	<div class="prompt orange">完善以下资料，<?php echo _cfg('web_name_two'); ?>购了么不会以任何形式公开您的个人隐私，请放心填写！<s></s></div>
	<div class="info">
	<form class="registerform" method="post" action="<?php echo WEB_PATH; ?>/member/home/usermodify">
		<table border="0" cellpadding="0" cellspacing="8">
			...
			<tr>
				...
				<td><textarea name="qianming" class="info_txtarea gray03" >写两句，让别人看到不一样的你！</textarea></td>
				<?php  else: ?>
