            ...
            $(function() {
                var b = function() {
                    ...
                    $('#btnSave').click(function() {
                        ...
                        submiting = true;
                        $.post("<?php echo WEB_PATH; ?>/mobile/user/mobilesuccess", post, function(s) {
                            if (s == 123) {
                                $.PageDialog.ok('验证码发送成功', function() {
                                    window.location.href = "<?php echo WEB_PATH; ?>/mobile/user/mobiles2/" + $mobile.val();
                                });
                            } else {
                                submiting = false;
                                the.text('提交');
