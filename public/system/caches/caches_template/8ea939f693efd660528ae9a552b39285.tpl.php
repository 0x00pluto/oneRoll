...
<div class="R-content">
	...
	<div class="yg_record_goods">
		...
		<div class="yg_record_r">
			...
			幸运号码：<?php echo $jiexiao['q_user_code']; ?> 】</li>
	...
	<div class="goods-tit gray02">
		<p class="fl">本期商品您总共云购<span><?php echo $record['gonumber']; ?></span>人次 拥有<span><?php echo $record['gonumber']; ?></span>个幸运号码</p><a href="<?php echo WEB_PATH; ?>/member/home/userbuylist" class="blue fr">&lt;&lt; 返回列表</a>
	</div> 
