...
<!-- 内页顶部 -->
        ...
        <section class="clearfix g-share-lucky" style="padding-top: 65px;">        
			...
			<a class="fl u-lucky-img" href="<?php echo WEB_PATH; ?>/mobile/mobile/userindex/<?php echo $shaidan['sd_userid']; ?>"><img border="0" style="border-radius: 100px;" alt="" src="<?php if($touxiang !='photo/member.jpg'): ?>
                    ...
                    <?php endif; ?>"> </a>
			<div class="u-lucky-r">
				<p>幸运获得者：<a href="<?php echo WEB_PATH; ?>/mobile/mobile/userindex/<?php echo $shaidan['sd_userid']; ?>" class="z-user blue"><?php echo $shaidanname['username']; ?></a></p>
				<?php 
                ...
                <ul id="replyList" style="border: 1px solid #dcdcdc;border-top: none;border-radius: 0px 0px 5px 5px;">
					...
					<li>
						<a class="fl u-comment-img" href="<?php echo WEB_PATH; ?>/mobile/mobile/userindex/<?php echo $sdhf['sdhf_userid']; ?>">
							...
							<?php elseif (userid($sdhf['sdhf_userid'],'img')=='photo/member.jpg'): ?>
							<img id="imgUserPhoto" src="<?php echo userid($sdhf['sdhf_userid'],'headimg'); ?>"  border="0"/>
							<?php  else: ?>
							<img id="imgUserPhoto" src="<?php echo G_UPLOAD_PATH; ?>/<?php echo userid($sdhf['sdhf_userid'],'img'); ?>"  border="0"/>
							<?php endif; ?>		
						</a>
						<div class="u-comment-r">
							<p class="z-comment-name"><a href="<?php echo WEB_PATH; ?>/mobile/mobile/userindex/<?php echo $sdhf['sdhf_userid']; ?>" class="blue">
							<?php echo get_user_key($sdhf['sdhf_userid'],'username'); ?></a><b style="float: right;"><?php echo date("Y-m-d H:i",$sdhf['sdhf_time']); ?></b></p>
							<p class="gray6" id="shaidang"><span><?php echo $sdhf['sdhf_content']; ?></span></p>
						</div>
					</li>
