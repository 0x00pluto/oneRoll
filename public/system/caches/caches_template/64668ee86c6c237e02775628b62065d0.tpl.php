	...
	<section class="clearfix g-member g-goods" style="padding-top: 50px;background: #fff;">
		<article class="mt10 m-round" style="margin:10px;border: none;box-shadow: 0px;">
            ...
            function update(id){    
				...
				$("#skfs2").val($("#item_"+id).attr("skfs"));
                $("#skr2").val($("#item_"+id).attr("skr"));
                $("#skzh2").val($("#item_"+id).attr("skzh"));
			...
			<div class="R-content">
				<div id="addressListDiv" class="list-tab detailAddress gray01" style="">
					<ul class="m-useraddresslst ">
						...
						<li style="margin-top: 10px;border: 1px solid #dcdcdc;border-radius: 5px;box-shadow: 1px #e7e7e7;" class="pad" id="item_<?php echo $dz['id']; ?>" qqnb="<?php echo $dz['qq']; ?>" shr="<?php echo $dz['shouhuoren']; ?>" yb="<?php echo $dz['youbian']; ?>" mob="<?php echo $dz['mobile']; ?>" skfs="<?php echo $dz['skfs']; ?>" skr="<?php echo $dz['skr']; ?>" skzh="<?php echo $dz['skzh']; ?>">
							<div class="q1">
								奖品收货地址
							...
							<div class="s2">
								<ul>
									...
									<li><?php echo $dz['skfs']; ?></li>
									<li><?php echo $dz['skr']; ?></li>
									<li><?php echo $dz['skzh']; ?></li>
								</ul>
							</div>
						</li>
	...
	<section class="clearfix g-member g-goods" style="background: #fff;margin: 10px;">
		...
		<div id="div_consignee" class="addAddress" style="display:none;position:absolute;top: 50px;;left: 0px;width: 100%;">
			<article class="mt10 m-round" style="margin:10px;padding: 10px;">
				...
				<dl style="font-size: 14px;color: #f60;">添加收货地址<br><span style="padding-left:16px;color:red;">以下选项必须全部填写，否则会导致提交失败或者再次重新提交</span></dl>
				<form class="registerform" method="post" action="<?php echo WEB_PATH; ?>/mobile/home/useraddress">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tbody>
							...
							<td>
								<select datatype="*" nullmsg="收货方式不能为空" id="txt_ship_mb" runat="server" name="skfs" class="select">
						...
						<tr class="hanggao">
							...
							<td>
								<input datatype="*" nullmsg="收货人不能为空" name="skr" type="text" id="txt_ship_mb" value="" class="input" maxlength="66">
								<em id="ship_mb_valid_msg" class="red">*</em>
							</td>
						</tr>
						<tr class="hanggao">
							...
							<td>
								<input datatype="*" nullmsg="收货帐号不能为空" name="skzh" type="text" id="txt_ship_mb" value="" class="input" maxlength="66">
								<em id="ship_mb_valid_msg" class="red">*</em>
							</td>
						</tr>
	...
	<article class="mt10 m-round" style="border: none;">
		<div id="div_consignee2" class="addAddress" style="display:none;position:absolute;width: 100%;left: 0;top: 50px;background: #fff;padding: 0;">
			...
			<form id="registerform3" class="registerform" method="post" style="margin: 10px;padding: 10px;border: 1px solid #dcdcdc;box-shadow: 1px 1px 1px #e7e7e7;border-radius: 5px;">
				<dl style="font-size: 14px;color: #f60;">修改收货地址<br><span style="padding-left:16px;color:red;">以下选项必须全部填写，否则会导致提交失败或者再次重新提交</span></dl>
				<table border="0" cellpadding="0" cellspacing="0" width="99%">
					<tbody>
						...
						<tr class="hanggao">
							...
							<td>
								<input  class="input" id="dizh" datatype="*1-100" nullmsg="请填街道地址！" errormsg="范围在100之间！" name="jiedao" type="text" class="street" maxlength="100" />
								<em id="ship_address_valid_msg" class="red">*</em>
							</td>
						</tr>
						<tr class="hanggao">
							...
							<td>
								<select datatype="*" nullmsg="收货方式不能为空" id="skfs" runat="server" name="skfs" class="select">
								<option value="转入余额" selected="selected">转入余额</option>
								<option value="转入支付宝" >转入支付宝</option>
								<option value="配送商品" >配送商品</option>
								</select>
						...
						<tr class="hanggao">
							...
							<td>
								<input datatype="*" nullmsg="收货人不能为空" name="skr" type="text" id="skr" class="input" maxlength="66" class="inputTxt">
								<em id="ship_mb_valid_msg" class="red">*</em>
							</td>
						</tr>
						<tr class="hanggao">
							...
							<td>
								<input datatype="*" nullmsg="收货帐号不能为空" name="skzh" type="text" id="skzh" class="input" maxlength="66" class="inputTxt">
								<em id="ship_mb_valid_msg" class="red">*</em>
							</td>
						</tr>
							<tr class="hanggao">
