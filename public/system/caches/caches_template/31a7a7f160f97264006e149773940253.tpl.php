...
<head>
    ...
    <title>验证身份 - <?php echo $webname; ?></title>
    ...
    <a href="<?php echo WEB_PATH; ?>/mobile/mobile" class="z-shop" style="background-position: 2px -73px;"></a>
        ...
        <section style="padding-top: 55px;">
	        <div class="registerCon">
	            <input type="hidden" id="inpMobile" name="mobile" value="<?php echo $mobile; ?>" />
    	        <ul>
	    ...
	    submiting = true;
            $.post("<?php echo WEB_PATH; ?>/mobile/user/step2chk",post,function(s){
            if (s==123) {
                window.location.href="<?php echo WEB_PATH; ?>/mobile/user/step3";
            } else {
                submiting = false;
                the.text('提交');
                $.PageDialog.fail(s);
