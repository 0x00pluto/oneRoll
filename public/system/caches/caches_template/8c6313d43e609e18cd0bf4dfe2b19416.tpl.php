...
<!-- 内页顶部 -->
   ...
   <header class="header" style="position: fixed;width: 100%;z-index: 99999999;">
    ...
    <div class="fr head-r" style="position: absolute;right: 66px;top: 1px;">
...
<div class="main-content clearfix" style="padding-top: 55px;">
<section>
...
var the = $(this).text('正在提交');
    submiting = true;
            $.post("<?php echo WEB_PATH; ?>/mobile/user/step3chk",post,function(s){
            if (s==123) {
                $.PageDialog.fail("密码修改成功");
                window.location.href="<?php echo WEB_PATH; ?>/mobile/user/login";
            } else {
                submiting = false;
                the.text('提交');
                $.PageDialog.fail(s);
