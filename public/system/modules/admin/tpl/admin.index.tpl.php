...
.left_date li:hover{ background-color:#053A2B;text-decoration:none;border-bottom:1px solid #3c8dbc; color: #FFF;height: 34px; cursor: pointer;}

.left_date .set{background-color:#053A2B;font-weight:bold;color:#3c8dbc;}

.left_date .head{ border-bottom:1px solid #c5e8f1; color:#FFF; font-weight:bold;background: #05654B;padding-left:15px; height: 34px;}
...
<div id="header">
    ...
    欢迎您：<a href="javascript:;" title="<?php echo $info['username']; ?>"><?php echo $info['username']; ?> [购了么管理员]</a>
