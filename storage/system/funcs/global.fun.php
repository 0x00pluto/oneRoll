...
//		$TestHtml = G_CACHES.'caches_template'.DIRECTORY_SEPARATOR.dirname($style).DIRECTORY_SEPARATOR.($module.'.'.$template).'.tpl.php';
...
//                    return $FileTpl;
//                } else {
//                    _error('template error message','The "'.$module.'.'.$template .'" template file does not exist');
//                }
//
//			}
//
...
//		_error('template message','The "'.$module.'.'.$template .'" template file does not exist');
    ...
    $ret = callRpc("mall.getAll",['start'=>0,'count'=>1]);
    var_dump($ret);
}
