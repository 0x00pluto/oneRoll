...
<div class="R-content">
	...
	<div class="total"><dt>
	</dt><dd>您已连续签到：<b class="orange"><?php echo $qiandao['lianxu']; ?></b>天</dd>  <dd>总共签到：<b class="orange"><?php echo $qiandao['sum']; ?></b>天</dd>  <dd>最后签到日期：<?php if($qiandao['time']==''): ?>
	<b class="orange">
	还未签到</b>
	<?php  else: ?>
	<b class="orange">
	<?php echo date("Y-m-d",$qiandao['time']); ?></b>
	<?php endif; ?></dd>
	</div>
	<div class="info">
