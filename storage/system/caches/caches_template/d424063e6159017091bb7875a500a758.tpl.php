...
<link rel="stylesheet" type="text/css" href="<?php echo G_TEMPLATES_STYLE; ?>/css/layout-invitation.css"/>
              <div class="R-content">
            <div class="member-t"><h2>佣金明细</h2>&nbsp;&nbsp;(<?php echo $tuiguangdengji; ?>)</div>
            <div class="total">
        	    <dt>
...
<!--             <div class="record-tit">
            ...
            <div id="divCommissionList" class="list-tab commission gray02"><ul class="listTitle"><li class="w140">用户</li><li class="w280">时间</li><li class="w280">描述</li><li class="w140">云购金额(元)</li><li class="w140">佣金(元)</li></ul>
			<?php if($yongjinticheng>0): ?>
			<ul>
			<li class="w140">所有邀请好友</a></li>
			<li class="w280"><?php echo date('Y-m-d H:i:s',$brokerage['time']); ?></li><li class="w280">邀请好友佣金提成</li><li class="w140">0.00</li><li class="w140 orange">+<?php echo $yongjinticheng; ?></li>
			</ul>
			<?php endif; ?>
			<?php if($recodetotal!=0): ?>
				<?php $ln=1; if(is_array($recodearr)) foreach($recodearr AS $key => $val): ?>
			<ul>
			<li class="w140"><a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($val['uid']); ?>" target="_blank"><img src= "<?php echo G_UPLOAD_PATH; ?>/<?php echo get_user_key($val['uid'],'img'); ?>" alt="" border="0"></a><a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($val['uid']); ?>" target="_blank" class="blue"><?php echo $username[$val['uid']]; ?></a></li>
			<li class="w280"><?php echo date('Y-m-d H:i:s',$val['time']); ?></li><li class="w280"><?php if($uid==$val['uid']): ?><?php echo $val['content']; ?><?php  else: ?><a target="_blank" href="<?php echo WEB_PATH; ?>/goods/<?php echo $val['shopid']; ?>" title="<?php echo $val['content']; ?>" class="blue"><?php echo $val['content']; ?></a><?php endif; ?></li><li class="w140"><?php echo $val['ygmoney']; ?></li><li class="w140 orange"><?php if($uid==$val['uid']): ?>-<?php  else: ?>+<?php endif; ?><?php echo $val['money']; ?></li>
			</ul>
