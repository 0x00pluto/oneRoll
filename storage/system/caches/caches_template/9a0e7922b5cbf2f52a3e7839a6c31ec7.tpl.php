...
var n = $("#hidLineLink").val();
    ...
    wx.onMenuShareAppMessage({
        title: "我给您分享了一份来自“购了么”的幸运礼物", // 分享标题
        desc: "最新一期【<?php echo $item['title']; ?>】开奖进行中，快来围观！", // 分享描述
        link: n, // 分享链接
        imgUrl: "<?php echo G_UPLOAD_PATH; ?>/<?php echo $item['thumb']; ?>", // 分享图标
        type: '', // 分享类型,music、video或link，不填默认为link
        dataUrl: '', // 如果type是music或video，则要提供数据链接，默认为空
    ...
    wx.onMenuShareWeibo({
        ...
        cancel: function () { 
		    ...
		    <?php  else: ?>
              ...
              <div id="btnBuyBox" class="pBtn" codeid="<?php echo $item['id']; ?>">
				<a style="width: 43%;margin-right: 2%;margin-left: 1%;" href="javascript:;" class="fl buyBtn">立即云购</a>
        ...
        <div class="joinAndGet">
    	    <dl>
				...
				<a href="<?php echo WEB_PATH; ?>/mobile/mobile/goodspost/<?php echo $item['sid']; ?>"><b class="fr z-arrow"></b>已有<span class="orange arial"><?php echo count($shaidan); ?></span>个中奖者晒单<strong class="orange arial"><?php echo $sum; ?></strong>条评论</a>
                                                    <a href="<?php echo WEB_PATH; ?>/mobile/mobile/goodsdesc/<?php echo $item['id']; ?>"><b class="fr z-arrow"></b>图文详情<em>（建议WIFI下使用）</em> </a>
				<a style="border-color: #efefef;box-shadow:0px 0px 0px #e7e7e7;" href="<?php echo WEB_PATH; ?>/mobile/mobile/buyrecords/<?php echo $item['id']; ?>"><b class="fr z-arrow jilu"></b>所有云购记录</a>
            </dl>
        <!-- 上期获得者 
		<?php if($item['q_end_time'] !=''): ?>
			<?php if(( $item['q_end_time']!='' && $item['q_end_time'] > time() ) ): ?>
			<?php  else: ?>
                ...
                <li class="getInfo">
                    ...
                    <dd>幸运中奖码：<em class="orange arial"><?php echo $gorecode['huode']; ?></em></dd>
        ...
        -->
                ...
                <div class="goodsList" style="clear: both;overflow:visible;">
                    ...
                    <a id="btnLoadMore2" class="loading" style="display:none; padding-top: 0px;color: #999;margin-top: -1px;position: relative;top: -1px;">~~木有更多云友参与了~~</a>
                    <a id="btnLoadMore3" class="loading" style="display:none; padding-top: 0px;color: #999;margin-top: -1px;position: relative;top: -1px;">~~木有更多云友参与了~~</a>
