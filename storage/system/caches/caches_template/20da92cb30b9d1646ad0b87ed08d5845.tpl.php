...
<style type="text/css">
    ...
    .head_search .ico_search {
        background: url("<?php echo G_WEB_PATH; ?>/statics/templates/yungou/images/mix-icon.png") no-repeat -120px -100px;
        display: block;
        height: 17px;
        width: 19px;
        z-index: 1000;
...
<header class="header" style="position: fixed; width: 100%;z-index: 99999999;background: #edebeb;border-bottom: 1px solid #d8d8d8;">
        ...
        <a class="daohangguanbi" onclick="history.go(-1)" href="javascript:;"><img width="30" height="30" src="/statics/templates/yungou/images/fanhui1.png"></a>
<!--
