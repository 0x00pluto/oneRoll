         ...
         <div class="R-content">
            <div class="member-t"><h2>邀请好友</h2></div>
		        ...
		        <div id="divInvited" class="success-invitation gray02"  >
			        <p>复制链接邀请好友可得高额佣金！ <a target="_blank" href="<?php echo WEB_PATH; ?>/single/pleasereg" class="blue">详情&gt;&gt;</a></p>
			        <span><b></b><input id="txtInfo"  style="width:500px;height:20px; " disabled="disabled" value="1元就能买IPhone 6S哦，快去看看吧！ <?php echo WEB_PATH; ?>/register/<?php echo $uid; ?>" onpaste="return false" type="text"></span>
