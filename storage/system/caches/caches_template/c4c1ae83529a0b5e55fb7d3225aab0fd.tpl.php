...
<div class="index_body">
	<div class="index_body_zxjx">
		<div class="index_body_ksyg"><a href="<?php echo WEB_PATH; ?>//help/1"><img src="<?php echo G_TEMPLATES_STYLE; ?>/images/index_body_ksyg.jpg" /></a></div>
				...
				<ul>
					...
					<li>
						...
						<div class="index_body_focus">
							<div class="index_body_jx_img"><a href="<?php echo WEB_PATH; ?>/dataserver/<?php echo $sq['id']; ?>" title="<?php echo $sq['title']; ?>" target="_blank"><img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $sq['thumb']; ?>" /></a></div>
							<div class="index_body_jx_cont">
								<p class="index_body_jx_title"><a href="<?php echo WEB_PATH; ?>/dataserver/<?php echo $sq['id']; ?>" title="<?php echo $sq['title']; ?>" target="_blank">(第<?php echo $sq['qishu1']; ?>期) <?php echo $sq['title']; ?></a></p>
								<span>总需：<?php echo $sq['zongrenshu']; ?>人次</span>
								<p>获奖者：<a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($sq['q_uid']); ?>" title="<?php echo get_user_name($sq['q_user']); ?>(ID:<?php echo $sq['q_uid']; ?>)"><b><?php if($sq['q_user']['username']!=null): ?>
		...
		<div class="index_body_tjsp_cont">
			...
			<ul class="w-goodsList-djs">
				...
				<li class="w-goodsList-item">
					<div class="index_body_tjsp_img"><a  href="<?php echo WEB_PATH; ?>/dataserver/<?php echo $djs['id']; ?>" title="<?php echo $djs['title']; ?>" target="_blank"><img alt="<?php echo $djs['title']; ?>" src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $djs['thumb']; ?>" /></a></div>
					<p><a title="<?php echo $djs['title']; ?>" href="<?php echo WEB_PATH; ?>/dataserver/<?php echo $djs['id']; ?>" target="_blank">(第<?php echo $djs['qishu']; ?>期) <?php echo $djs['title']; ?></a></p>
					<?php if($djs['q_end_time']<$timenow): ?>
					<div class="countdown_end">
						<p class="countdown_end_p">恭喜<a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($djs['q_uid']); ?>" title="<?php echo get_user_name($djs['q_user']); ?>(ID:<?php echo $djs['q_uid']; ?>)"><?php echo get_user_name($djs['q_user']); ?></a>获得</p>
					</div>
					<?php  else: ?>
...
function show_date_time_location(){
	...
	//	$("#divLotteryTiming").show();	
		...
		$.post("<?php echo WEB_PATH; ?>/api/getshop/lottery_shop_set/",{"lottery_sub":"true","gid":djs,"times":Math.random()},function(data){
			if(data!=0)
			{
				if(djs)
				{
			...
			<div class="index_body_hjjl">
				...
				<div class="bd">
					<ul>
						...
						<?php if($i%2==0): ?>
						<li>
							<div class="index_body_jlimg"><a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($qishu['q_uid']); ?>"><img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $qishu['q_user']['img']; ?>" /></a></div>
							<div class="index_body_jlcont">
								<p class="index_body_jlcont_name1"><a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($qishu['q_uid']); ?>" target="_blank" title="<?php echo get_user_name($qishu['q_user']); ?>(ID:<?php echo $qishu['q_uid']; ?>)"><?php echo get_user_name($qishu['q_user']); ?></a>于<?php echo date('m月d日',$qishu['q_end_time']); ?></p>
								<p class="index_body_jlcont_cont"><?php echo $user_goods_num; ?>人次夺得<a title="<?php echo $qishu['title']; ?>" href="<?php echo WEB_PATH; ?>/dataserver/<?php echo $qishu['id']; ?>" target="_blank"><?php echo $qishu['title']; ?></a></p>
			...
			<div class="index_body_cyjl">
				...
				<div class="bd">
					<ul>
						...
						<li>
							<div class="index_body_jlimg"><a href="<?php echo WEB_PATH; ?>/goods/<?php echo $gorecord['shopid']; ?>"><img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo shopimg($gorecord['shopid']); ?>" /></a></div>
							<div class="index_body_jlcont">
								<p class="index_body_jlcont_name"><a class="w-record-user" title="<?php echo get_user_name($gorecord); ?>(ID:<?php echo $gorecord['uid']; ?>)" href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($gorecord['uid']); ?>" target="_blank"><?php echo get_user_name($gorecord); ?></a>参与了</p>
								<p class="index_body_jlcont_cont"><?php echo $gorecord['gonumber']; ?>人次 <a title="<?php echo $gorecord['shopname']; ?>" href="<?php echo WEB_PATH; ?>/goods/<?php echo $gorecord['shopid']; ?>" target="_blank"><?php echo $gorecord['shopname']; ?></a></p>
								<p></p>
							</div>
						</li>
						<?php  endforeach; $ln++; unset($ln); ?>
		...
		<div class="index_body_zrjp_right">
			...
			<div class="index_body_zrjp_cont">
				...
				<div class="index_body_zrjp_item">
					...
					<div class="index_body_zrjp_img"><a  href="<?php echo WEB_PATH; ?>/goods/<?php echo $renqi['id']; ?>" title="<?php echo $renqi['title']; ?>" target="_blank"><img alt="<?php echo $renqi['title']; ?>" src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $renqi['thumb']; ?>" /></a></div>
					<p class="index_body_zrjp_title"><a  title="<?php echo $renqi['title']; ?>" href="<?php echo WEB_PATH; ?>/goods/<?php echo $renqi['id']; ?>" target="_blank">(第<?php echo $renqi['qishu']; ?>期) <?php echo $renqi['title']; ?></a></p>
	...
	<div class="index_body_sjpb">
		...
		<div class="index_body_sjpb_cont">
			<?php $ln=1;if(is_array($shoplistshouji)) foreach($shoplistshouji AS $qita): ?>
				...
				<?php endif; ?>
					<div class="index_qgjp_img"><a href="<?php echo WEB_PATH; ?>/goods/<?php echo $qita['id']; ?>" title="<?php echo $qita['title']; ?>" target="_blank"><img alt="<?php echo $qita['title']; ?>" src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $qita['thumb']; ?>"/></a></div>
					<p class="index_qgjp_title"><a href="<?php echo WEB_PATH; ?>/goods/<?php echo $qita['id']; ?>" title="<?php echo $qita['title']; ?>" target="_blank">(第<?php echo $qita['qishu']; ?>期) <?php echo $qita['title']; ?></a></p>
		...
		<div class="index_body_qtjp_cont">
			<?php $ln=1;if(is_array($shoplistqita)) foreach($shoplistqita AS $qita): ?>
				...
				<?php if($qita['yunjiage']=='10.00'): ?>							
					<i class="index_body_ten_ioc"></i>
				<?php endif; ?>
				<div class="index_qgjp_img"><a href="<?php echo WEB_PATH; ?>/goods/<?php echo $qita['id']; ?>" title="<?php echo $qita['title']; ?>" target="_blank"><img width="200" height="150" alt="<?php echo $qita['title']; ?>" src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $qita['thumb']; ?>" /></a></div>
				<p class="index_qgjp_title"><a title="<?php echo $qita['title']; ?>" href="<?php echo WEB_PATH; ?>/goods/<?php echo $qita['id']; ?>" target="_blank">(第<?php echo $qita['qishu']; ?>期) <?php echo $qita['title']; ?></a></p>
				<p class="index_qgjp_price">总需：<?php echo $qita['zongrenshu']; ?>人次</p>
				<div class="progressBar">
					<p class="progressBar_wrap"><span class="progressBar_bar" style="width:<?php echo $rq_width; ?>%;"></span></p>
					<ul class="progressBar_txt">
				...
				<li>
					<i class="index_body_zxsj_ioc"></i>
						<div class="index_body_zxsj_conts">
							<p class="index_body_zxsj_conts_p p1"><a href="<?php echo WEB_PATH; ?>/goods/<?php echo $new['id']; ?>" title="<?php echo $new['title']; ?>" target="_blank"><?php echo $new['title']; ?></a></p>							
							<div class="index_body_zxsj_conts_img">
							<a href="<?php echo WEB_PATH; ?>/goods/<?php echo $new['id']; ?>" title="<?php echo $new['title']; ?>" target="_blank"><img alt="<?php echo $new['title']; ?>" src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $new['thumb']; ?>"  /></a>
							</div>
						</div>
		...
		<div class="index_body_sdhp_cont">
			<ul>
            	...
            	$sd['sd_content']=strip_tags($sd['sd_content']);
            	 ?>
				<li>
					<div class="index_body_sdhp_img"><a href="<?php echo WEB_PATH; ?>/go/shaidan/detail/<?php echo $sd['sd_id']; ?>" target="_blank"> <img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $sd['sd_thumbs']; ?>" /></a></div>
					<div class="index_body_sdhp_conts">
						<b><a title="<?php echo get_user_name($sd['sd_userid']); ?>(ID:<?php echo $sd['sd_userid']; ?>)" href="<?php echo WEB_PATH; ?>/uname/<?php echo $sd['sd_userid']; ?>" target="_blank"><?php echo get_user_name($sd['sd_userid']); ?></a><span><?php echo date("Y-m-d",$sd['sd_time']); ?></span></b>
